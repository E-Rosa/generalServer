...
class PageForecast {
    ...
    displayMainForecast(parent) {
        ...
        forecastMainTemp.textContent = (this.temp + "Cº");
        pageForecastContainer.appendChild(forecastMainTemp);
    }
    displayReducedForecast(parent, cachedForecastData) {
        ...
        let reducedForecastCardsContainer = document.createElement("section");
        ...
        function displayReducedCards() {
            for (let i = firstPosition; i <= firstPosition + 2; i++) {
                ...
                forecastReducedTemp.textContent = (newForecast.temp + "Cº");
